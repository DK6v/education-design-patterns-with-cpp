...
public:
    ...
    virtual void step1() { std::cout << "-- " << whoami() << ": step1" << std::endl; };
    virtual void step2() { std::cout << "-- " << whoami() << ": step2" << std::endl; };

    void action() { // non virtual, interface
        std::cout << "-- Base: [" << *this << "]: action" << std::endl;
        step1();
        step2();
    }
};
...
public:
    ...
    void action() { // inversed
        std::cout << "-- Derived: [" << *this << "]: action" << std::endl;
        step2();
        step1();
    }
};
...
public:
    ...
    void step1() { std::cout << "-- " << whoami() << ": step1" << std::endl; };
    void step2() { std::cout << "-- " << whoami() << ": step2" << std::endl; };
};
